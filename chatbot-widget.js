...
function startConversation() {
    fetch('https://chatbot-for-kidovations-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
  ...
  //  sendInputToGAS3(userMessage, true);
    ...
    fetch('https://chatbot-for-kidovations-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbz6o-ZuaA254bEE1O0cMjneq9pk1eadiYRhU1470oH_hcT7nt3hCGKoNX8xF3mqAFRP/exec';
